...
if __name__ == '__main__':
    ...
    embeddings = glove.transform(x_train)
    # test_embeddings = glove.transform(x_test)
    model = Sequential([
        vectorize_layer,
        Embedding(vocab_size, embedding_dim, weights=[embeddings], trainable=False),
    ])
    ...
    model.fit(x_train, y_train, epochs=20, verbose=1, validation_split=0.1, batch_size=64,
